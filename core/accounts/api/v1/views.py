...
from .serializers import (
    UserAndSignupSerializer,
    ChangePasswordSerializer,
    LoginSerializer,
    TokenLoginSerializer,
    JWTCreateSerializer,
    SendActivateTokenSerializer,
    SendForgetPasswordTokenSerializer,
...
class UserAPIView(GenericAPIView):
    ...
    def get(self, request):
        ...
        return Response(
            {"details": "need authentication to see user information"},
